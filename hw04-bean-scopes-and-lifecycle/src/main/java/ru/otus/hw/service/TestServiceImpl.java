...
public class TestServiceImpl implements TestService {
    ...
    private int getStudentAnswer(int questionsSize) {
        int min = 1;
        String prompt = ioService.getMessage("TestService.write.number.prompt", min, questionsSize);
        String errorMessage = ioService.getMessage("TestService.write.number.error");
